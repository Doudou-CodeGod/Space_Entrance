...
scene.background = new THREE.Color( 0x000000 );    
    ...
    const materials = {
        ...
        'painting': new THREE.MeshPhongMaterial( { color: 0xffffff, specular: 0x111111, shininess: 1, map: texture } ),
...
function setupGui() {
    ...
    const createHandler = function ( id ) {
        ...
        return function () {
            ...
            effect.enableUvs = ( current_material === 'painting' ) ? true : false;
            effect.enableColors = ( current_material === 'painting' || current_material === 'painting' ) ? true : false;
